...
void TITLECARDS_TownSquare(const char* path, const HelperFunctions& helperFunctions)
{
    ...
    if (HD_GUI)
    {
        index += "\\textures\\TitleCards\\TS-HD\\index.txt";
    ...
    {
        index += "\\textures\\TitleCards\\TS-SD\\index.txt";
...
{
	ReplaceTex("AVA_MULTI", "multistg0700", "MultiThumbnails", "STP_Multi-TS-S", 54926008, 128, 72);
	ReplaceTex("AVA_MULTI", "multistg0701", "MultiThumbnails", "STP_Multi-TS-K", 71757014, 128, 72);
}
...
void STAGECREDITS_TownSquare(const char* path, const HelperFunctions& helperFunctions)
{
    if (HD_GUI)
    {
        ReplaceTex("ENDBG_SONIC_2", "s_ev023", "StageCredits", "STP_HD-Credits-TS-S00", 366022, 256, 256);
        ReplaceTex("ENDBG_SUPERSONIC_0", "ss_ev008", "StageCredits", "STP_HD-Credits-TS-S01", 366156, 256, 256);
        ReplaceTex("ENDBG_KNUCKLES_1", "k_ev016", "StageCredits", "STP_HD-Credits-TS-K00", 366065, 256, 256);
        ReplaceTex("ENDBG_KNUCKLES_1", "k_ev017", "StageCredits", "STP_HD-Credits-TS-K01", 366066, 256, 256);
    }

    else if (DC_Conversion)
    {
        ReplaceTex("ENDBG_SONIC_2", "s_ev023", "StageCredits", "STP_DC-Credits-TS-S00", 366022, 256, 256);
        ReplaceTex("ENDBG_SUPERSONIC_0", "ss_ev008", "StageCredits", "STP_DC-Credits-TS-S01", 366156, 256, 256);
        ReplaceTex("ENDBG_KNUCKLES_1", "k_ev016", "StageCredits", "STP_DC-Credits-TS-K00", 366065, 256, 256);
        ReplaceTex("ENDBG_KNUCKLES_1", "k_ev017", "StageCredits", "STP_DC-Credits-TS-K01", 366066, 256, 256);
    }

    else
    {
        ReplaceTex("ENDBG_SONIC_2", "sonic_24", "StageCredits", "STP_DX-Credits-TS-S00", 366023, 512, 512);
        ReplaceTex("ENDBG_KNUCKLES_1", "knuckles_19", "StageCredits", "STP_DX-Credits-TS-K00", 366068, 512, 512);
        ReplaceTex("ENDBG_KNUCKLES_2", "knuckles_20", "StageCredits", "STP_DX-Credits-TS-K00", 366069, 512, 512);
    }
}
